...
<body>
        ...
        <div class="col-12 row content">
            ...
            <div class="col-10">
                <div class="col-12 mt-5 text-center">
                    <h2>Register Services Usage</h2>
                </div>
                <div class="line"></div>
                <div class="col-12 mt-4 wrapper-card">
                    <div class="card create-customer-card">
                        <h5 class="card-header">Register Service Form</h5>
                        <div class="card-body">
                            <form action="CreateServiceUsage" method="post" id="create-detail-service-form " modelAttribute="serviceUsage">
                                ...
                                <div class="form-group height-form-label">
                                    ...
                                    <!-- <input type="text" class="form-control" id="serviceID" placeholder="Enter the ServiceID" maxlength="50" name="serviceID"> -->
                                    
                                    <select class="form-control" id="serviceID" name="serviceID">
                                        <c:forEach var="ele2" items="${lstService}">
                                            <option value="${ele2.serviceID}">${ele2.serviceID}</option>
                                        </c:forEach>
                                    </select>
                                ...
                                <div class="form-group height-form-label">
                                    ...
                                    <input type="date" class="form-control" id="date-service" placeholder="Chose Date Of Usage" maxlength="50" name="dayOfUseService">
                                    <small id="date-service-err" class="form-text text-danger"></small>
                                </div>

                                <div class="form-group height-form-label">
                                    <label class="label-color font-label">Time Of Usage</label>
                                    <input type="time" class="form-control" id="time-services-use" placeholder="Chose Time Of Usage" maxlength="50" name="timeOfUseService">
                                    <small id="time-services-use-err" class="form-text"></small>
                                </div>

                                <div class="form-group height-form-label">
                                    <label class="label-color font-label">Quantity</label>
                                    <input type="number" class="form-control" id="quantity" placeholder="Choose Quantity" maxlength="50" name="quantity" min="1" max="20">
                                    <small id="quantity-err" class="form-text text-danger"></small>
                                </div>

                                <button type="button" class="btn btn-success" id="btn-addRegisterService">Submit</button>
    ...
    <script type="text/javascript" src="<c:url value="/js/validatorDetailService.js"/>"></script>
</body>
</html>