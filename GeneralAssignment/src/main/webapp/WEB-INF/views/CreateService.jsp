            ...
            <div class="col-10">
                ...
                <div class="col-12 mt-4 wrapper-card">
                    <div class="card create-computer-card">
                        <h5 class="card-header">Services Form</h5>
                        <div class="card-body">
                            <form action="CreateService" method="post" id="create-service-form" modelAttribute="services">

                                <div class="form-group height-form-label">
                                    <label class="label-color font-label">ServiceID</label>
                                    <input type="text" class="form-control" id="serviceID" placeholder="Enter the ServiceID"
                                        maxlength="50" name="serviceID">
                                    <small id="serviceID-err" class="form-text text-danger"></small>
                                </div>

                                <div class="form-group height-form-label">
                                    <label class="label-color font-label">Service Name</label>
                                    <input type="text" class="form-control" id="serviceName" placeholder="Enter the Service Name"
                                ...
                                <button type="button" id="btn-addService" class="btn btn-success">Submit</button>
